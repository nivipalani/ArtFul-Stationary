		...
		<div class="col-lg-12">
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6">
					<address>
						<strong>Supplier Information</strong><br>Name :${order.product.supplier.supplier_Name}
						<br>Email ID :${order.product.supplier.supplier_emailid} <br>
						Location :${order.product.supplier.location}<br>
					</address>
				</div>
